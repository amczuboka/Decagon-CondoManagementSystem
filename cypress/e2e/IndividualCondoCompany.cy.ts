...
// This script automates an acceptance test for viewing an Individual Condo page as a Company user.
// The test checks if essential elements such as features, descriptions, price details, and locations are visible and test the editing for authorized company.
